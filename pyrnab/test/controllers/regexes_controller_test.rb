...
class RegexesControllerTest < ActionController::TestCase
  ...
  test "should create regex" do
    assert_difference('Regex.count') do
      post :create, regex: { description: @regex.description, group_name: @regex.group_name, id: @regex.id, ordinal: @regex.ordinal, regex: @regex.regex, status: @regex.status }
    end
  ...
  test "should update regex" do
    patch :update, id: @regex, regex: { description: @regex.description, group_name: @regex.group_name, id: @regex.id, ordinal: @regex.ordinal, regex: @regex.regex, status: @regex.status }
    assert_redirected_to regex_path(assigns(:regex))
  end
